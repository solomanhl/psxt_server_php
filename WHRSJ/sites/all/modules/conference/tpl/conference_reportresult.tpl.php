...
<body style="width: 700px; margin-left: 30px;">
	...
	<div style="margin-top: 150px;">
		...
		<div
			...
			<?php echo "<b style=\"font-family: 黑体;\">"."评审时间："."</b>"."&nbsp;&nbsp;&nbsp;".$nian."&nbsp;&nbsp;"."年"."&nbsp;&nbsp;".$yue."&nbsp;&nbsp;"."月"."&nbsp;".$ri."&nbsp;"."日";?>
		</div>
		<div
			style="margin-left: 30px; font-family: 宋体; font-size: 16pt; line-height: 50px;">
			<?php echo "<b style=\"font-family: 黑体;\">"."评审地点："."</b>"."&nbsp;&nbsp;&nbsp;".$cnfname->location; ?>
		</div>
		<div
			style="margin-left: 30px; font-family: 宋体; font-size: 16pt; line-height: 50px;">
			<?php global $user; echo "<b style=\"font-family: 黑体;\">"."工作人员："."</b>"."&nbsp;&nbsp;&nbsp;".$user->r_name; ?>
				...
				while ($data = db_fetch_object($export_result)) {
					...
					if($len >= 60){
						...
						if(strlen($experts[$i]) > 18){
							echo "<td colspan=\"2\" align=\"left\">".$experts[$i]."</td>";
						}
						else{
							echo "<td width=\"70px\" align=\"right\">".$experts[$i]."</td>";
						}
						...
						if($flag == 1){
							if(strlen($experts[$i]) == 6){
								echo "<tr>";
								echo "<td width=\"90px\">".$experts[$i]."</td>";
							}
							...
							if(strlen($experts[$i]) > 18){
								echo "<tr>";	
								echo "<td colspan=\"2\">".$experts[$i]."</td>";
							}	
						}
						else{
							if(strlen($experts[$i]) == 6){

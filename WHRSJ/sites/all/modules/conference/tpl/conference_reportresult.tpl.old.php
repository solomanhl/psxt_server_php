...
<body style="width: 650px; margin-left: 30px;">
	...
	<div style="margin-top: 100px;">
		...
		<div
			style="margin-left: 30px; font-family: 黑体; font-size: 14pt; line-height: 40px;">
			<?php echo "工作人员：".$staff->r_name; ?>
		</div>
		<div style="height: 300px;">
			<div
				style="margin-left: 30px; font-family: 黑体; font-size: 14pt; line-height: 40px;">
				<?php echo "到会评委：".$zrpw."(主任委员)";?>
			</div>
			<div
				style="margin-left: 130px; font-family: 黑体; font-size: 14pt; line-height: 40px;">
				<?php
				$expert = "0,";
				...
				while ($data = db_fetch_object($export_result)) {
	            	...
	            	if($data->name != $zrpw){
						$experts[$i] = $data->name;
		            	if ($i%4==0){
							if($data->position == "副主任委员"){
								echo $experts[$i]."(副主任委员)"."</br>";
								$i = 0;
							}
							else{
								echo $experts[$i]."</br>";

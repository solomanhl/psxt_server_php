 ...
 */
$db_url = 'mysql://whrsj:whrsj$westi@localhost/whrsj';
$db_prefix = '';
 ...
 * for you.
 */
 $base_url = 'http://192.168.2.111';  // NO trailing slash!
...
ini_set('session.cache_expire',     60000);
ini_set('session.cache_limiter',    'none');
ini_set('session.cookie_lifetime',  60000);
